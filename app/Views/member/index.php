...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="filter-panel no-print card">
            <div class="body filter-header"
                style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; padding: 5px 20px; border-bottom: 2px solid #ddd; margin-bottom: 15px;"
                onclick="toggleFilters()">
                <h4 style="margin: 0;">
                    <i class="material-icons" style="vertical-align: middle;">filter_list</i> Filters
                </h4>
                <button type="button" class="btn btn-sm btn-primary" id="filterToggleBtn">
                    <i class="material-icons" style="font-size: 18px !important;">expand_more</i>
                    <span id="toggleText">Show Filters</span>
                </button>
            </div>

            <div id="filterForm" class="body" style="display: none;">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="member_type" class="form-control">
                                    ...
                                    <option value="1" <?php echo ($filters['member_type'] == '1') ? 'selected' : ''; ?>>
                                        Ordinary</option>
                                    <option value="3" <?php echo ($filters['member_type'] == '3') ? 'selected' : ''; ?>>
                                        Life
                                        Member</option>
                                    <option value="DM" <?php echo ($filters['member_type'] == 'DM') ? 'selected' : ''; ?>>
                                        Deceased Member (DM)</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    Demise</option> -->
                                    <option value="deceased" <?php echo ($filters['status'] == 'deceased' || $filters['status'] == 'demise') ? 'selected' : ''; ?>>
                                        Deceased</option>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="tamil_month" class="form-control">
                                    <option value="">All Months</option>
                                    <?php
                                    // Predefined Tamil months in order
                                    $tamil_month_list = ['Chithirai', 'Vaigasi', 'Aani', 'Aadi', 'Aavani', 'Purattasi', 'Aipasi', 'Karthigai', 'Margazhi', 'Thai', 'Maasi', 'Panguni'];
                                    foreach ($tamil_month_list as $month) { ?>
                                        <option value="<?php echo $month; ?>" <?php echo (isset($filters['tamil_month']) && $filters['tamil_month'] == $month) ? 'selected' : ''; ?>>
                                            <?php echo $month; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                    ...
                    <div class="row" style="margin-top: 0px;">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="lunar_phase" class="form-control">
                                    <option value="">All Phases</option>
                                    <?php
                                    // Predefined Lunar phases
                                    $lunar_phase_list = ['Sukla Paksham', 'Krishna Paksham', 'Pournami', 'Amavasai'];
                                    foreach ($lunar_phase_list as $phase) { ?>
                                        <option value="<?php echo $phase; ?>" <?php echo (isset($filters['lunar_phase']) && $filters['lunar_phase'] == $phase) ? 'selected' : ''; ?>>
                                            <?php echo $phase; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Thithi</label>
                                <select name="thithi" class="form-control">
                                    <option value="">All Thithis</option>
                                    <?php
                                    // Predefined Thithis
                                    $thithi_list = ['Prathamai', 'Dvithiyai', 'Thrithiyai', 'Chathurthi', 'Panchami', 'Sashti', 'Sapthami', 'Ashtami', 'Navami', 'Dasami', 'Ekadasi', 'Dwadasi', 'Thrayodasi', 'Chathurdasi', 'Pournami', 'Amavasai'];
                                    foreach ($thithi_list as $thithi_val) { ?>
                                        <option value="<?php echo $thithi_val; ?>" <?php echo (isset($filters['thithi']) && $filters['thithi'] == $thithi_val) ? 'selected' : ''; ?>>
                                            <?php echo $thithi_val; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>&nbsp;</label>
                                <a href="<?php echo base_url(); ?>/member" class="btn btn-default btn-block">
        ...
        <div class="column-toggles no-print">
            ...
            <div class="showdiv" style="display: flex; flex-wrap: wrap; gap: 10px;">
                    ...
                    <div class="header">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right no-print">
                                    ...
                                    <button type="button" class="btn bg-orange waves-effect">
                                        ...
                                        <?php if ($draft_count > 0) { ?>
                                            <span class="badge bg-white"
                                                style="color:#ff9800;"><?php echo $draft_count; ?></span>
                                        <?php } ?>
                                    </button>
                                </a>
                                ...
                                <!-- ADD THIS -->
                                <a href="<?php echo base_url(); ?>/member/sticker_print">
                                    <button type="button" class="btn bg-teal waves-effect">
                                        <i class="material-icons">print</i> Sticker Print
                                    </button>
                                </a>
                                            ...
                                            <td class="no-print">
                                                <div class="btn-group-action">
                                                    ...
                                                    <a class="btn btn-primary btn-xs"
                                                        href="<?= base_url() ?>/member/print_registration/<?php echo $row['id']; ?>"
...
<script>
    $(document).ready(function () {
        // View Member Card Modal - FIXED: Added // to make this a comment
    ...
    // View Member Card Function - MUST BE OUTSIDE $(document).ready()
...
<script>
    function toggleFilters() {
        ...
        var icon = document.querySelector('#filterToggleBtn i');
