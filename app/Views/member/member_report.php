...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2><?php echo $lang->member; ?> <?php echo $lang->report; ?> <small><?php echo $lang->member; ?> /
                    <b><?php echo $lang->member; ?> <?php echo $lang->report; ?></b></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="body">
                        ...
                        <form action="<?php echo base_url(); ?>/report/member_report_print" method="get"
                            target="_blank">
                            <div class="container-fluid">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-2 col-sm-3">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <label class="form-label"><?php echo $lang->member; ?>
                                    ...
                                    <div class="col-md-12 col-sm-12" style="margin:0px;">
                                        ...
                                        <input name="pdf_member" type="submit"
                                            class="btn btn-danger btn-lg waves-effect" id="pdf_archanaireport"
                                            value="PDF">
                                        <input name="excel_member" type="submit"
                            ...
                            <table class="table table-striped dataTable" id="datatables">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:25%;"><?php echo $lang->member; ?> <?php echo $lang->name; ?>
                                        </th>
                                        <th style="width:15%;"><?php echo $lang->membership; ?> <?php echo $lang->no; ?>
                                        </th>
                                        <th style="width:20%;"><?php echo $lang->member; ?> <?php echo $lang->type; ?>
                                        </th>
