    ...
    <div class="container-fluid">
        ...
        <div class="filter-panel no-print">
            ...
            <form method="GET" action="<?php echo base_url(); ?>/member">
                ...
                <!-- Second Row: Tamil Calendar Filters -->
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="thithi" class="form-control">
                                ...
                                <?php 
                                // Predefined Thithis
                                $thithi_list = ['Prathamai', 'Dvithiyai', 'Thrithiyai', 'Chathurthi', 'Panchami', 'Sashti', 'Sapthami', 'Ashtami', 'Navami', 'Dasami', 'Ekadasi', 'Dwadasi', 'Thuvaathasi', 'Chathurdasi', 'Pournami', 'Amavasai'];
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <button type="button" class="btn bg-orange waves-effect">
                    ...
                    <?php if ($draft_count > 0) { ?>
                        <span class="badge bg-white" style="color:#ff9800;"><?php echo $draft_count; ?></span>
                    <?php } ?>
                </button>
            </a>
