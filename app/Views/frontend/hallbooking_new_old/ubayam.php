                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="hidden" id="pack_row_count_addon" value="0">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <ul class="payment1">
                                                            <li>
                                                                <input type="radio" name="payment_mode" id="cb1" value="1" />
                                                                <label for="cb1"><i class="mdi mdi-square-inc-cash"></i><br>Cash</label>                                                                 
                                                            </li>
                                                            <li>
                                                                <input type="radio" name="payment_mode" id="cb2" value="2" />
                                                                <label for="cb2"><i class="mdi mdi-qrcode"></i><br>QR</label>
                                                            </li>
                                                            <li>
                                                                <input type="radio" name="payment_mode" id="cb3" value="3" />
                                                                <label for="cb3"><i class="mdi mdi-credit-card-multiple"></i> <br>Card</label>
                                                            </li>
                                                            <li>
                                                                <input type="radio" name="payment_mode" id="cb4" value="4" />
                                                                <label for="cb4"><i class="mdi mdi-web"></i> <br>Online</label>
                                                            </li>  
                                                             <li>
                                                                <input type="radio" name="payment_mode" id="cb5" value="5" />
