<body>
    ...
    <div style="width: 150mm;font-weight: 600;font-family: monospace; display: none;" id="booking_tickets">
        ...
        <div style="width: 150mm;font-weight: 600;font-family: monospace;" class="booking_ticket">
            ...
            <hr>
            <p style="text-align: center; font-size:28px;">Product Offering Voucher</p>
            <hr>

            <table style="border: none;">
                <tr>
                    <td style="border: none; text-align: left; width: 40%;"><b>Date:</b></td>
                    <td style="border: none; text-align: left;">
                        <?php echo date('d-m-Y', strtotime($data['date'])); ?>
                    </td>
                </tr>
                <tr>
                    <td style="border: none; text-align: left;"><b>Invoice:</b></td>
                    <td style="border: none; text-align: left;"><?php echo $data['ref_no']; ?></td>
                </tr>
                <tr>
                    <td style="border: none; text-align: left;"><b>Name:</b></td>
                    <td style="border: none; text-align: left;"><?php echo $data['name']; ?></td>
                </tr>
                <tr>
                    <td style="border: none; text-align: left;"><b>Phone:</b></td>
                    <td style="border: none; text-align: left;"><?php echo $data['phone']; ?></td>
                </tr>
                <?php if (!empty($data['remarks'])) { ?>
                    <tr>
                        <td style="border: none; text-align: left;"><b>Remarks:</b></td>
                        <td style="border: none; text-align: left;"><?php echo $data['remarks']; ?></td>
                    </tr>
                <?php } ?>
            </table>
            ...
            <table style="border: 1px solid #000;">
                <thead>
                    <tr>
                        <th style="border: 1px solid #000; text-align: center;">Category</th>
                        <th style="border: 1px solid #000; text-align: center;">Product</th>
                        <th style="border: 1px solid #000; text-align: center;">Qty</th>
                        <th style="border: 1px solid #000; text-align: right;">Grams</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    foreach ($offering_items as $item) {
                        ...
                        ?>
                        <tr>
                            <td style="border: 1px solid #000; text-align: center;"><?php echo $item['category_name']; ?>
                            </td>
                            <td style="border: 1px solid #000; text-align: center;"><?php echo $item['product_name']; ?>
                            </td>
                            <td style="border: 1px solid #000; text-align: center;"><?php echo $item['quantity']; ?></td>
                            <td style="border: 1px solid #000; text-align: right;"><?php echo $item['grams']; ?></td>
                        </tr>
                    <?php } ?>
                    <tr>
                        <td colspan="3" style="border: 1px solid #000; text-align: center;"><b>Total Grams</b></td>
                        <td style="border: 1px solid #000; text-align: right;"><b><?php echo $total_grams; ?></b></td>
                    </tr>
                </tbody>
            </table>

            <br>
            <p style="text-align: center; font-size: 20px;">Thank You for Your Offering</p>
            <hr>
        </div>
