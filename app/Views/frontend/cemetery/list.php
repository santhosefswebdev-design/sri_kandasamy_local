                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 5%;">
                                                ...
                                                {
                                                ?>
                                                <?php /* <label style="background: #FF9800;padding: 7px 10px;color: #fff;font-weight: bold;">Paid</label> */ ?>
                                                <label style="background: #20a530;padding: 7px 10px;color: #fff;font-weight: bold;">Paid</label>
                                                <?php
                                                }
