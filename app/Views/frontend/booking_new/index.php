...
.paid_txt { color:green; float:right; margin-right:15px; line-height:2em; font-weight:bold; }
...
<body class="sidebar-icon-only">
                                ...
                                <div class="col-xl-8 col-sm-6 col-lg-7 col-md-7 stretch-card flex-column">
                                    ...
                                    <ul id="filters" class="clearfix prod1">
                                       ...
                                       foreach ($package as $key => $value) {
                                           if (!empty($value)) {
                                               ?>
                                                    <li><span class="filter" data-filter=".<?php if (!empty($key)) {
                                                ...
                                                ?>
                                                      <div
                                                        ...
                                                        data-cat="<?php if (!empty($key)) {
                                                          ...
                                                          <input type="checkbox" class="package_amt" data-id="<?php echo $row['id']; ?>" name="pay_for" value="<?php echo $row['id']; ?>" id="pay_for<?php echo $row['id']; ?>" />
                                                          <label class="card" for="pay_for<?php echo $row['id']; ?>" onclick="payfor(<?php echo $row['id']; ?>)" >
                                                          <img class="img-fluid prod_img" src="<?php echo base_url(); ?>/uploads/hall/<?php echo $row['image']; ?>">
                                                          <div class="d-flex justify-content-between align-items-center mb-2 mt-2" style="flex-direction: column;">
                                                            <p class="mb-0 text-muted arch" id="pay_name<?php echo $row['id']; ?>"><?php echo $row['name']; ?></p>
                                                          </div>
                                                          </label>
  ...
  <button type="button" class="btn ar_btn1 btn-danger btn-lg" id="delete-button">Delete</button>
                                    ...
                                    <p style="text-align:right; margin-top:5px; margin-bottom:5px;"><button type="button" class="btn ar_btn btn-info btn-lg" onClick="userModalOpen();">Add Detail</button></p>
</div>
                                    <table class="show-cart table table-bordered" style="width:100%;display:none;"></table>
                                    
                                    <div class="prod" style="max-height:170px; height:170px; overflow:auto;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center" style="width:100%; border-bottom:1px dashed #CCC;">
                                        <p class="mb-0" style="font-size: 23px;font-weight: bold;">Pay For RM :</p>
                                        <p class="mb-0"> 
                                            <input type="hidden" id="payfor_thirty_percent_amt" class="form-control"  name="payfor_thirty_percent_amt">
                                            <input type="number" step="any" id="payfor_total_amt" class="form-control"  name="payfor_total_amt" placeholder="0.00" style="text-align: right;">
                                        </p>
                                    </div>
                                     <ul class="payment1">
                            ...
                            if(response.length > 0) {
                                $.each(response, function(key,value) {
                                    ...
                                    var html = '<tr id="rmv_packrow'+countid+'" data-pack_id="'+pack_id+'" class="cart_services">';
                                        ...
                                        html += '<input type="hidden" name="service[' + countid +'][service_id]" value="' + serviceid +'" >';
    ...
    if(events.length===0) {
        ...
        for(var i=0; i<events.length; i++) {
            ...
            else
            {
                ...
                var event_count = $("<div class='event-name'>" + repay + "<a class='btn btn-primary book_sts' style='font-size: 13px;font-weight: bold;padding: 5px;' title='Print' href='"+url+"/booking/list_booking_print/"+events[i]["event_id"]+"' target='_blank'>Print</a></div>");
