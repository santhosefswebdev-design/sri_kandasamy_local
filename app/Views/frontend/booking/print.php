...
?>
<div style="max-width: 80mm;max-height:auto;font-weight: 600;font-family: monospace;" class="office_copy">
	...
	<p style="font-size:18px;"><?php echo $temp_details['name']; ?></p>
	...
	Tel: <?= $_SESSION['telephone_frend']; ?></p>
	<hr>
...
<div style="max-width: 80mm;max-height:auto;font-weight: 600;font-family: monospace;" class="customer_copy">
	<p style="border-bottom: 3px dotted #9E9E9E;max-width: 80mm;"></p>
	<h3 style="text-align: center;text-transform: uppercase;max-width: 80mm;margin: 5px 0;font-size: 16px;">Customer Copy</h3>
	<p style="border-bottom: 3px dotted #9E9E9E;max-width: 80mm;"></p>
	<br>
	<div style="max-width: 80mm;max-height: auto;font-weight: 600;font-family: monospace;">
	<p><img src="<?php echo base_url(); ?>/uploads/main/<?php echo $temp_details['image']; ?>" style="width:120px;" align="center"></p>
