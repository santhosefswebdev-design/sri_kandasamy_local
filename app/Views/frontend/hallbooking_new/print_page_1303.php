...
<tr>
    <td style="text-align: left;">
        ...
        <?php echo isset($booked_bride_details[0]['name']) ? $booked_bride_details[0]['name'] : 'N/A'; ?><br>
                        <strong>Bride DOB:</strong>
                        <?php echo isset($booked_bride_details[0]['dob']) ? date('d-m-Y', strtotime($booked_bride_details[0]['dob'])) : 'N/A'; ?><br>
                        <strong>Bride IC:</strong>
                        <?php echo isset($booked_bride_details[0]['nric']) ? $booked_bride_details[0]['nric'] : 'N/A'; ?>
                    </td>
                    <td style="text-align: left;">
                        <strong>Groom Name:</strong>
                        <?php echo isset($booked_groom_details[0]['name']) ? $booked_groom_details[0]['name'] : 'N/A'; ?><br>
                        <strong>Groom DOB:</strong>
                        <?php echo isset($booked_groom_details[0]['dob']) ? date('d-m-Y', strtotime($booked_groom_details[0]['dob'])) : 'N/A'; ?><br>
                        <strong>Groom IC:</strong>
                        <?php echo isset($booked_groom_details[0]['nric']) ? $booked_groom_details[0]['nric'] : 'N/A'; ?>
                    </td>
                </tr>
				<!-- <tr>
                    <td style="text-align: center;">
