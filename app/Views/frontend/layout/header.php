...
<head>
   ...
   <title>
      <?php echo $_SESSION['site_title_frend']; ?>
   </title>
         ...
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-white">
               ...
               <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                  <ul class="navbar-nav">
                     <?php
                     // Check if the logged-in user's ID is 31
                     if ($_SESSION['log_id_frend'] == 31) {
                        // Show only the "Sales" menu for user with ID 31
                        ?>
                        <li class="nav-item <?php if ($uri_one == "archanai_booking") {
                           echo 'active';
                        } ?>">
                           <a class="nav-link" href="<?php echo base_url(); ?>/archanai_booking">SALES</a>
                        </li>
                        ...
                        <!-- <li class="nav-item <?php if ($uri_one == "kattalai_archanai") {
                           echo 'active';
                              ...
                              href="<?php echo base_url(); ?>/kattalai_archanai_online">KATTALAI ARCHANAI
                           </a></li> -->
                        ...
                        <li class="nav-item <?php if ($uri_one == "ubayam_online") {
                           echo 'active';
                        } ?>"><a class="nav-link" href="<?php echo base_url(); ?>/templeubayam_online/ubayam">UBAYAM
                           </a></li>
                        ...
                        <li class="nav-item <?php if ($uri_one == "commission_online") {
                           echo 'active';
                        } ?>"> <a class="nav-link" href="<?php echo base_url(); ?>/commission_online">PRIEST
                              COMMISSION</a>
                        </li>
                        <li class="nav-item <?php if ($uri_one == "Dailyclosing_online") {
                           echo 'active';
                     ...
                     <li class="dropdown nav-item <?php if ($uri_one == "Dailyclosing_online") {
                        ...
                        <?php
                        // Check if the logged-in user is NOT ID 31
                        if ($_SESSION['log_id_frend'] != 31) {
                           ?>
                           <a class="nav-link" href="#" data-toggle="dropdown">REPORT <span class="tw-indicator"><i
                           ...
                           <ul class="dropdown-menu tw-dropdown-menu">
                              ...
                              if (!empty($_SESSION['role'])) {
                                 if ($_SESSION['role'] == 92) {
                                    ?>
                                    <li class="active"><a href="<?php echo base_url(); ?>/report_online/archanai_report">Archanai
                                          Report</a></li>
                                    <?php
                                 } else {
                                    ?>
                                    <li><a href="<?php echo base_url(); ?>/report_online/archanai_report">Archanai Report</a>
                                    </li>
                                    <!-- <li><a href="<?php echo base_url(); ?>/report_online/hall_booking_report">Hall Booking
                                          Report</a></li> -->
                                    <li><a href="<?php echo base_url(); ?>/report_online/ubayam_report">Ubayam Report</a></li>
                                    <li><a href="<?php echo base_url(); ?>/report_online/prasadam_rep_view">Prasadam Report</a>
                                    </li>
                                    <li><a href="<?php echo base_url(); ?>/report_online/annathanam_report">Annathanam Report</a>
                                    </li>
                                    <li><a href="<?php echo base_url(); ?>/report_online/donation_report">Donation Report</a>
                                    </li>
                                    <!-- <li><a href="<?php echo base_url(); ?>/report_online/kattalai_archanai_report">Kattalai
                                          Archanai Report</a></li> -->
                                    <li><a href="<?php echo base_url(); ?>/report_online/offering_report">Offering Report</a>
                                    </li>
                                    <li><a href="<?php echo base_url(); ?>/report_online/floating_cash_report">Floating Cash
                                          Report</a></li>
                                    <li><a href="<?php echo base_url(); ?>/report_online/floating_cash_report">Floating Cash
                                          Report</a></li>
                                    <li><a href="<?php echo base_url(); ?>/report_online/tax_exemption_report">Tax Exemption
                                          Report</a></li>
