...
<tr><td colspan="2"><h2 style="text-align:center;"> Ubayam Voucher </h2></td></tr>
...
<tr><td colspan="2">
    ...
    <tr><td><b>Pay For </b> </td><td><?php echo $qry1['uname']; ?></td></tr>
    <tr><td><b>Amount(RM) </b> </td><td><?php echo number_format($qry1['amount'], '2','.',','); ?></td></tr>
    <tr><td><b>Paid Amount(RM) </b> </td><td><?php echo number_format($qry1['paidamount'], '2','.',','); ?></td></tr>
    <tr><td><b>Balance Amount(RM) </b> </td><td><?php echo number_format($qry1['balanceamount'], '2','.',','); ?></td></tr>
