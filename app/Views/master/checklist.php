...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>
                <?php echo $lang->checklist; ?><small>
                    <?php echo $lang->booking; ?> / <b>
                    ...
                    <div class="header">
                        <div class="row">
                            ...
                            <div class="col-md-4" align="right"><a
                                    href="<?php echo base_url(); ?>/master/add_checklist"><button type="button"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-rad" title="View"
                                                    href="<?= base_url() ?>/master/view_checklist/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE417;</i></a>


                                                <a class="btn btn-primary btn-rad" title="Edit"
                                                    href="<?= base_url() ?>/master/edit_checklist/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE3C9;</i></a>
