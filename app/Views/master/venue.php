                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- <a class="btn btn-danger btn-rad" title="Delete"
                                                    href="<?= base_url() ?>/master/delete_venue/<?php echo $row['id']; ?>"><i class="material-icons">&#xE872;</i></a> -->
...
<script>
    function confirm_modal(id) {
        $.ajax({
            url: "<?php echo base_url(); ?>/master/del_venue_check",
            type: "post",
            data: { id: id },
    ...
    function dedDel(id) {
        var act = "<?php echo base_url(); ?>/master/delete_venue/" + id;
