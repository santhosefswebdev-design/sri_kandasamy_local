                    ...
                    <div class="header">
                        <div class="row">
                            ...
                            <div class="col-md-4" align="right"><a
                                    href="<?php echo base_url(); ?>/master/add_service"><button type="button"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-primary btn-rad" title="Edit"
                                                    ...
                                                    href="<?= base_url() ?>/master/delete_service/<?php echo $row['id']; ?>"><i class="material-icons">&#xE872;</i></a>
