...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Donation<small>Donation / <b><?php echo $lang->group; ?></b></small></h2>
        </div>
        <!-- Basic Examples -->
                ...
                <div class="card">
                    ...
                    <div class="body">
                    	<?php if($_SESSION['succ'] != '') { ?>
                            ...
                            <?php } ?>
                        <form action="<?php echo base_url(); ?>/master/save_donation_group" method="POST">
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<a class="btn btn-success btn-rad" title="View" href="<?= base_url()?>/master/view_donation_group/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                            <a class="btn btn-primary btn-rad" title="Edit" href="<?= base_url()?>/master/edit_donation_group/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
...
<script>
    ...
    function dedDel(id)
    {
        var act = "<?php echo base_url(); ?>/master/delete_donation_group/"+id;
