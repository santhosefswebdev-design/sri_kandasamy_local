...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2><?php echo $lang->hall; ?> <?php echo $lang->package; ?>  <small><?php echo $lang->booking; ?> / <b><?php echo $lang->hall; ?><?php echo $lang->package; ?><?php echo $lang->setting; ?></b></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/master/add_hall"><button type="button" class="btn bg-deep-purple waves-effect"><?php echo $lang->add; ?></button></a></div></div>
                    </div>
                    <?php } ?>
                    <div class="body">
                ...
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <h4 class="mt-2"><?php echo $lang->delete; ?><?php echo $lang->hall; ?><?php echo $lang->package; ?></h4>
                            <table>
