...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2><?php echo $lang->rental; ?><small><?php echo $lang->rental; ?> / <b><?php echo $lang->rental; ?> <?php echo $lang->type; ?> <?php echo $lang->setting; ?></b></small></h2>
        </div>
        <!-- Basic Examples -->
									...
									<div class="col-sm-3">
										<div class="form-group form-float">
											<div class="form-line">
												...
												<label class="form-label"><?php echo $lang->rental; ?> <?php echo $lang->type; ?><span style="color: red;"> *</span></label>
											</div>
										</div>
									</div>
                ...
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <h4 class="mt-2"><?php echo $lang->delete; ?> <?php echo $lang->rental; ?> <?php echo $lang->type; ?></h4>
                            <table>
