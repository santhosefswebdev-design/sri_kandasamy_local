...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>General <small>Advertisement / <b>Advertisement List</b></small></h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/advertisement/add"><button type="button" class="btn bg-deep-purple waves-effect"><?php echo $lang->add; ?></button></a></div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($bookings as $booking): ?>
                                            <tr>
                                                ...
                                                <!-- <td><?= esc($booking['type']); ?></td> -->
                                                <!-- <td><?= esc($booking['description']); ?></td> -->
                                                <td><?= esc($booking['type']) == '1' ? 'Image' : 'Video'; ?></td>
                                                <td><?= esc($booking['status']) == '1' ? 'Active' : 'In Active'; ?></td>
                                                <td style="width: 16%;">
                                                    <!-- <a class="btn btn-success btn-rad" href="<?= base_url() ?>/advertisement/view/<?= $booking['id']; ?>"><i class="material-icons">&#xE417;</i></a>                                               -->
                                                    <a class="btn btn-warning btn-rad" href="<?= base_url() ?>/advertisement/edit/<?= $booking['id']; ?>"><i class="material-icons">&#xE3C9;</i></a>                        
    ...
    function confirm_modal(id) {
        ...
        $("#spndeddelid").text("Are you sure to Delete this Advertisement?");
        $('#delete-form').attr('action', '<?php echo base_url(); ?>/advertisement/delete/' + id);
    }
</script>
