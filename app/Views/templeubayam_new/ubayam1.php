                                                                    ...
                                                                    <ul class="booking_slots">
                                                                        ...
                                                                        <div class="tabs">
                                                                            <div class="tab active"
                                                                                data-target="#morning">MORNING</div>
                                                                            <div class="tab" data-target="#evening">
                                                                                EVENING</div>
                                                                        </div>
            ...
            ?>
                                                                ...
                                                                <div class="page">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <input type="hidden" id="pack_amount"
                                                                            name="pack_amount" class="form-control">
                                                                        <div class="col-sm-3 ">
                                                                            <div class="form-group form-float">
                                                                    ...
                                                                    <div class="row scroll"
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <input type="hidden"
                                                                                id="pack_row_count_addon" value="0">
                                                                        </div>
                                                                    </div>
                                                                    <div id="free_prasadam">
                                                                        <div class="col-sm-12">
                                                                            <h4
                                                                                style="margin-bottom:5px; margin-top:5px; text-align: left;">
                                                                                Free Prasadam</h4>
                                                                            <hr>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group form-float">
                                                                                    <div class="form-line">
                                                                                        <select class="form-control"
                                                                                            id="add_free_prasadam">
                                                                                            <option value="">Select
                                                                                                Prasadam from dropdown
                                                                                            </option>
                                                                        ...
                                                                        <div class="row scroll"
                                                                            style="overflow-y:scroll; overflow-x:hidden; height: 150px;">
                                                                            <div class="col-sm-12">
                                                                                <div class="table-responsive">
                                                                                    <table class="table table-bordered"
                                                                                        style="width:100%"
                                                                                        id="package_table_free_prasadam"
                                                                                        style="height: 150px;">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                <th width="50%">Name
                ...
                <a class="btn btn-success submit">Submit</a>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <span id="packname"
                                                            style="font-weight:bold;color:#d40087;"></span>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6"><input type="number" min="0" step="any"
                                                                id="total_amt" class="form-control" name="total_amt"
                                                                value="0"
                                                                style="margin-top:5px; height:35px;font-weight:bold;font-size: 30px;text-align: center;"
                                                                readonly></div>
                                                    </div>
    ...
    <script>
        ...
        var cnt = $("#package_table_free_prasadam tbody tr").length;
            ...
            if (id != '') {
                ...
                //                         html_f += '<td style="width: 10%;"><a class="btn btn-danger btn-rad" onclick="rmv_pack_addon(' + countid + ')" style="width:auto;padding: 0px 3px !important;"><i class="material-icons">X</i></a><input type="hidden" class="package_category_prasadam" value=' + id + '></td>';
                //                         html_f += '</tr>';
