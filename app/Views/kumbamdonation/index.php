...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2> <b> Kumbabishegam Donation</b></small></h2>
            </div>
            <!-- Basic Examples -->
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h4 style="white-space: nowrap;">நன்கொடை வழங்கியமைக்கு நன்றி <img src="<?php echo base_url(); ?>/assets/images/hand.png" style="width:15px; display:inline-block; vertical-align:middle;"> Thank You for your generous contribution !</h4>
    </div>
</div>
