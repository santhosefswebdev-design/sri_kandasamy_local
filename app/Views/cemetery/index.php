...
<section class="content">
    <div class="container-fluid">
            ...
            <h2><?php echo $lang->cemetery; ?><small><?php echo $lang->cemetery; ?> / <a href="#" target="_blank"><?php echo $lang->cemetery; ?> <?php echo $lang->setting; ?></a></small></h2>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <div class="row">
                            <div class="col-md-8"><h2><?php echo $lang->cemetery; ?></h2></div>
                    ...
                    <div class="body"> 
                        ...
                        <div class="row">
							...
							{ echo "display:block;"; } else { echo "display:none;"; } ?>"><?php echo $lang->save; ?></button>
						</div>
                    </div>
                    </form>
                </div>
