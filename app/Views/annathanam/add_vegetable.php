...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2> Vegetable<small>Annathanam / <b> Add Vegetable</b></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/annathanam/vegetables"><button type="button" class="btn bg-deep-purple waves-effect">List</button></a></div></div>
                    </div>
                    <form action="<?php echo base_url(); ?>/annathanam/save_vegetable" method="POST" enctype='multipart/form-data'>
                    <div class="body">
...
function validations(){
    $.ajax
        ({
        type:"POST",
        url: "<?php echo base_url(); ?>/annathanam/vegetable_setting_validation",
        data: $("form").serialize(),
