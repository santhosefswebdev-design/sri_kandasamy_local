...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2><?php echo $lang->product; ?> <?php echo $lang->donation; ?> <small><?php echo $lang->donation; ?> / <a href="#" target="_blank"><?php echo $lang->product; ?> <?php echo $lang->donation; ?></a></small></h2>
            </div>
            <!-- Basic Examples -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<?php if($permission['create_p'] == 1) { ?>
                        <div class="header">
                            <div class="row"><div class="col-md-8"><h2><?php echo $lang->product; ?> <?php echo $lang->donation; ?></h2></div>
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/productdonation/add"><button type="button" class="btn bg-deep-purple waves-effect"><?php echo $lang->add; ?></button></a></div></div>
                        </div>
						<?php } ?>
                        <div class="body">
                ...
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <h4 class="mt-2"><?php echo $lang->delete; ?> <?php echo $lang->product; ?> <?php echo $lang->donation; ?></h4>
                            <table>
