							...
							<div class="container-fluid">
								<div class="row clearfix">
                                    ...
                                    <div class="col-sm-3">
										<div class="form-group form-float">
											<div class="form-line">
												<input type="number"  class="form-control" name="order_no" required value="" >
												<label class="form-label"><?php echo $lang->order_no; ?><span style="color: red;"> *</span></label>
											</div>
										</div>
									</div>
									<div class="col-sm-2">
										<div class="form-group form-float">
											<div class="">
												...
												<label for="rasi" class="form-label"><?php echo $lang->rasi; ?> & <?php echo $lang->natchathram; ?> </label>
											</div>
										</div>
									</div>
