                        ...
                        <div class="header">
                            <div class="row">
                                ...
                                <div class="col-md-4" align="right">
                                    <!-- <a
                                        href="<?php echo base_url(); ?>/commission/add"><button type="button"
                                            class="btn bg-deep-purple waves-effect"><?php echo $lang->add; ?></button></a> -->
                                    <!-- Add this in the header section, next to the existing Add button -->
                                    <a href="<?php echo base_url(); ?>/commission/add_priest_commission">
                                        <button type="button" class="btn btn-info waves-effect">Add Priest
                                            Commission</button>
                                    </a>
                                </div>
                            </div>
                                                ...
                                                <td style="width: 16%;">
                                                    <?php if ($permission['view'] == 1) { ?>
                                                        <a class="btn btn-success btn-rad"
                                                            href="<?= base_url() ?>/commission/view/<?php echo $row['id']; ?>"><i
                                                                class="material-icons">&#xE417;</i></a>
                                                    <?php }
                                                    if ($permission['edit'] == 1) { ?>
                                                        <a class="btn btn-warning btn-rad"
                                                            href="<?= base_url() ?>/commission/edit/<?php echo $row['id']; ?>"><i
                                                                class="material-icons">&#xE3C9;</i></a>
                                                    <?php } ?>
