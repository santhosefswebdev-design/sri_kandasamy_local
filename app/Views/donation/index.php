...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2> <?php echo $lang->cash; ?> <?php echo $lang->donation; ?><small><?php echo $lang->donation; ?> / <b><?php echo $lang->cash; ?> <?php echo $lang->donation; ?></b></small></h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<?php if($permission['create_p'] == 1) { ?>
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/donation/add"><button type="button" class="btn bg-deep-purple waves-effect"><?php echo $lang->new; ?> <?php echo $lang->donation; ?></button></a></div></div>
                        </div>
					<?php } ?>
                        <div class="body">
