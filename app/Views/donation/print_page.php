...
<style>
        ...
        <div class="table-responsive col-md-12" style="background:#FFF; float:none;margin-bottom:0px;">
            <table class="table table-bordered table-striped table-hover">
                <tbody>
                    <tr>
                        <td colspan='2' style="text-align: center; font-weight: bold; padding: 10px; border: 1px solid #000; width: 30%">Description</td>
                        <td colspan='2' style="text-align: right; font-weight: bold; padding: 10px; border: 1px solid #000; width: 20%">Amount (RM)</td> 
                    </tr>
                </tbody>
                <tbody>
                        <tr>
