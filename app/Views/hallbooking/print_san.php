...
<table align="center" width="100%">
    ...
    <tr>
        <td colspan="2">
            ...
            <div class="container">
                ...
                <h4 style="text-align:center;text-decoration: underline;">TERMS AND CONDITIONS FOR THE TEMPLE SANNATHI BOOKING FOR WEDDING/ENGAGEMENT/BANGLE CEREMONY
                </h4>
                ...
                <table class="sub_table">
                    <h3>1.Sannathi Rental</h3>
                    <tr class="sub_row">
                        <td class="sub_head">Sannathi</td>
                        <td class="sub_head">RM 5,000.00</td>
                    </tr>
                    <tr class="sub_row">
                        <td class="sub_head">Security Fees</td>
                ...
                <ol type="i">
                    ...
                    <li>100 chairs for wedding at sannathi. Without cover. Separate charges for cover.</li>
					</ol>
  ...
  <label for="termsRead" style="line-height: 48px;">
    ...
    <input type="checkbox" name="termsRead" id="termsRead" style="width: 24px; height: 24px; vertical-align: middle;">
                ...
                <ol type="i">
                    <li>
                    For the request in change of date for a booked event, a written notice not later than 30 days from the date of booking must be lodged to the Temple requesting for the change. The Temple may provide another available date, if any. Should the written notice lodged to the Temple more than 30 days from the booking date the Temple shall forfeit the RM5,000 paid for the first booking. For the new booking date, additional RM5,000 shall be charged.
                    </li><br>
                    <li>
  ...
  <label for="termsRead" style="line-height: 48px;">
    ...
    <input type="checkbox" name="termsRead" id="termsRead" style="width: 24px; height: 24px; vertical-align: middle;">
                ...
                <ol type="i">
                   ...
                   <li>
				   Chairs, tables, canopy and covers for the chairs and the tables outside the hall for dinning food is separately charged and is not inclusive in the package. 
				   </li>
				   <li>
