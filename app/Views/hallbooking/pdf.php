<html>
	<head>
		<title>
		  <?php echo 'Hall Booking Invoice - ' . $temple_details['name']; ?>
		</title>
	...
	<body>
			  ...
			  <table style="width:100%">
				<tr>
				  <td width="40%" align="left">
					<img src="<?php echo base_url(); ?>/uploads/main/<?php echo $temple_details['image']; ?>" style="width:120px;" align="left">
				  ...
				  <td width="60%" align="left">
					...
					<p style="text-align:left; font-size:16px; margin:5px;">
					  ...
					  <?php echo $temple_details['address2']; ?>,<br>
					  <?php echo $temple_details['city'] . '-' . $temple_details['postcode']; ?><br>
					  Tel :<?= $temple_details['telephone']; ?>
					</p>
				  </td>
				</tr>
			  </table>
		...
		<tr><td align="left"><b>Date :</b> <?php $date= new DateTime($qry1['entry_date']) ;  echo $date->format('d-m-Y'); ?></td>
		...
		<tr><td colspan="2">
			...
			<td width="20%"><b>Event Date</b> </td><td width="30%"><?php echo date("d-m-Y", strtotime($qry1['booking_date'])); ?></td></tr>
			...
			<?php /* <tr><td><b>Register By</b> </td><td><?php echo $qry1['register_by']; ?></td> */ ?>
		...
		?>
		<tr><td colspan="2"><h4 style="text-align:center;"> Payment Details  </h4></td></tr>
		<tr>
		<td colspan="2">
			<table border="1" style="width:100%" align="center">
				<tr><th width="50%" style="text-align:left">Payment Date</th><th width="50%" style="text-align:left">Amount</th></tr>
				<?php
				foreach($pay_details as $pbd){
				?>
				<tr><td><?php echo date("d/m/Y", strtotime($pbd['date'])); ?></td><td><?php $total_amount = $pbd['amount']; echo number_format((float)$total_amount, 2, '.', '');; ?></td></tr>
				<?php
				}
				?>
			</table>
		...
		?>
		<tr><td colspan="2"><h4 style="text-align:center;"> Package Details  </h4></td></tr>
		<tr><td colspan="2">
			<table border="1" style="width:100%" align="center">
				<tr><td width="30%">Name</td><td width="50%">Description</td><td width="20%">Amount</td></tr>
				<?php
				foreach($hall_booking_details as $hbd){
				?>
				<tr><td><?php echo $hbd['service_name']; ?></td><td><?php echo $hbd['service_description']; ?></td><td><?php $total_amount = $hbd['service_amount']; echo number_format((float)$total_amount, 2, '.', '');; ?></td></tr>
				<?php
				}
				?>
			</table>
