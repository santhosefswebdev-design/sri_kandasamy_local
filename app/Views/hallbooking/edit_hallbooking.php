                                  ...
                                  <div class="products row scroll" style="overflow-y:scroll; overflow-x:hidden; height: 250px;">
                                        <table class="table table-bordered ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo date("g:i A", strtotime($row['name'])) .' - '.date("g:i A", strtotime($row['description'])); ?> (<?php echo $row['slot_season']?>)</td>
                                                    <td><?= $t_name; ?></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                   ...
                                   <div class="col-md-12">
                                    <div class="products row">
                                        ...
                                        <?php /* <div class="col-sm-6 smal_marg">
                                    ...
                                    <div class="row scroll" style="overflow-y:scroll; overflow-x:hidden;">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group form-float">
                                                <div class="form-line focused">
                                                    <input type="number" id="pay_amt" min="0" step=".01" class="form-control" placeholder="0.00">
                                        ...
                                        <div class="table-responsive"><table style="width:100%;" class="table table-bordered" id="pay_table" style="height: 150px;">
                                            ...
                                            <tbody>
                                                <?php $i=0; foreach($pay_details as $row) {
                                                    ...
                                                    <tr >
                                                        <td style="width: 63%;">
                                                            <input type="date" style="border: none;" readonly value="<?= $row['date'];?>">
                                                        </td>
                                                        <td><input type="text" style="border: none;" readonly class="pay_amt" value="<?= $row['amount'];?>"></td>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group form-float">
                                                        ...
                                                        <label class="form-label" style="display: contents; font-size: 14px;">Commission To</label>
                                                            <select class="form-control" name="commission_to[]" multiple="multiple" disabled>
                                                                <option value="">Select Staff</option>
                                                                <?php foreach($staff as $row) { 
                                                                $com = explode(',', $data['commision_to']);
                                                                    foreach($com as $commision) {
                                                                    ?>
                                                                    <option <?php if($commision == $row['id']) echo 'selected'; ?> value="<?php echo $row['id']; ?>"><?php echo $row['name']; ?></option>
                                                                    <?php } 
                                                                 } ?>
                                                            </select>
                                                        </div>
...
<script>
    ...
    // )};
        $("#status").change(function() {
            ...
            if($("#status option:selected").val()== 2 && balance != 0){
                $('#del-modal').modal('show', {backdrop: 'static'});
    ...
    $("#pay_add").click(function(){
        ...
        if(date != '' && amt != 0 && paymentmode != 0){
            ...
            var html = '<tr id="rmv_payrow'+cnt+'">';
                html += '<td style="width: 40%;"><input type="date" style="border: none;" readonly name="pay['+cnt+'][date]" value="'+date+'"></td>';
                html += '<td style="width: 20%;"><input type="text" style="border: none;" readonly class="pay_amt" name="pay['+cnt+'][pay_amt]" value="'+Number(amt).toFixed(2)+'"></td>';
    ...
    function rmv_pay(id){
        ...
        if(typeof pay_id === "undefined"){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>/hallbooking/refund_pay",
                type: "post",
                data: {pay_id: pay_id},
                success:function(data){
        ...
        if((pre_sts == 2 && balance != 0)){
            ...
            if(pre_sts != 3 && deposite_amt < check_dep){
                ...
                $("#spndeddelid").text("Minimum Deposit Amount RM "+check_dep);
                 ...
                 $.ajax({
                    type:"POST",
                    url: "<?php echo base_url();?>/hallbooking/update",
                    data: $("form").serialize(),
                    beforeSend: function() {    
                        $("#loader").show();
                    },
                    success:function(data)
                    {
                        ...
                        if(obj.err != ''){
						    ...
						    else window.location.replace("<?php echo base_url();?>/hallbooking/hallbook_list?date="+$('#event_date').val());
                        }
                    },
