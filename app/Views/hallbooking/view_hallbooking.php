                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="hall_id" value="<?php echo $data['id'];?>">
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="row scroll" >
                                        <table class="table table-bordered sub" id="pay_table" >
                                            <thead>
                                                <tr>
                                                    <th width="60%">Date</th>
                                            ...
                                            <tbody>
                                                <?php $i=0; foreach($pay_details as $row) {?>
                                                    <tr>
                                                        ...
                                                        <td style="width: 20%;"><?= $row['paymentname'];?></td>
                                                        <td style="width: 20%;"><input type="text" style="border: none;" readonly class="pay_amt" name="pay[<?= $i; ?>][pay_amt]" value="<?= $row['amount'];?>"></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
