...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>Templebooking <small>Temple Event / <b>Temple Special Event block</b></small></h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/specialeventblock/add"><button type="button" class="btn bg-deep-purple waves-effect"><?php echo $lang->add; ?></button></a></div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($bookings as $booking): ?>
                                            <tr>
                                                ...
                                                <td style="width: 16%;">
                                                    <a class="btn btn-success btn-rad" href="<?= base_url() ?>/specialeventblock/view/<?= $booking['id']; ?>"><i class="material-icons">&#xE417;</i></a>                                              
                                                    <a class="btn btn-warning btn-rad" href="<?= base_url() ?>/specialeventblock/edit/<?= $booking['id']; ?>"><i class="material-icons">&#xE3C9;</i></a>                        
    ...
    function confirm_modal(id) {
        ...
        $("#spndeddelid").text("Are you sure to Delete this Special Temple Event block?");
        $('#delete-form').attr('action', '<?php echo base_url(); ?>/specialeventblock/delete/' + id);
    }
</script>
