                                    ...
                                    foreach ($list as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if (!empty($row['proposer_1_member_no'])) { ?>
                                                    <br><small>(<?php echo $row['proposer_1_member_no']; ?>)</small>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <?php echo $row['proposer_2_name'] ?? '-'; ?>
                                                <?php if (!empty($row['proposer_2_member_no'])) { ?>
                                                    <br><small>(<?php echo $row['proposer_2_member_no']; ?>)</small>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <strong>RM <?php echo number_format($row['payment'], 2); ?></strong>
                                            </td>
                                            <td style="width: 20%;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="payment_status" class="form-control" required>
                                            <option value="2" selected>Confirmed/Paid</option>
...
<script>
    function approveModal(id) {
        ...
        if (paymentMode) {
            $('select[name="payment_mode"]').val(paymentMode);
        }
