                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-8 det">
                                   ...
                                   <h3 style="margin-bottom:5px; margin-top:5px; text-align: left;">Extra Charges </h3>
                                    <hr>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <label>Bride Name <span style="color: red;">*</span></label>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <label>Bride DOB <span style="color: red;">*</span></label>
                                                            ...
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <label>Bride IC Number <span style="color: red;">*</span></label>
                                                            ...
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <label>Groom Name <span style="color: red;">*</span></label>
                                                            ...
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <label>Groom DOB <span style="color: red;">*</span></label>
                                                            ...
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <label>Groom IC Number <span style="color: red;">*</span></label>
            ...
            $.ajax({
                ...
                success: function(data){
                    if (data.terms.length > 0) {
                        var t_html = '';
                        data.terms.forEach(function(value, key) {
                            var replacedValue = value.replace(/\[person_name\]/g, name).replace(/\[ic_number\]/g, ic_number).replace(/\[Address\]/g, address).replace(/\[booking_date\]/g, booking_date).replace(/\[entry_date\]/g, entry_date).replace(/\[booking_slot\]/g, booking_slot);
                            t_html += '<div class="form-group">' +
                                    '<label class="custom-checkbox">' +
                                    replacedValue +
				...
				if (data.data.status) {
					...
					setTimeout(function () {
                        ...
                        if(print == 1){
                            ...
                            window.open("<?php echo base_url(); ?>/templehallbooking/print_page/" + bookingId, '_blank');
                        } else {
                            window.location.replace("<?php echo base_url();?>/templehallbooking/hallbook_list?date=" + encodeURIComponent(date) + "&venue=" + encodeURIComponent(venue));
                        }
                    }, 2000);
