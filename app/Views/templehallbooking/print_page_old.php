...
<table align="center" width="100%">
	...
	<?php if(count($booked_bride_details) && count($booked_groom_details)){ ?>
	...
	<tr>
		<td colspan="2">
			<h4 style="text-align:center;"> Bride Details </h4>
		</td>
	</tr>
	<tr>
		<td colspan="2">
			<table border="1" style="width:100%" align="center">
				<tr>
					<th width="33%" style="text-align:left">Name</th>
					<th width="33%">Nric</th>
					<th width="33%" style="text-align:left">Dob</th>
				</tr>
				<tr >
					<td colspan="3" style="text-align: center;font-weight: bold;">Bride Details</td>
				</tr>
				<?php
				foreach ($booked_bride_details as $row) {
				...
				?>
				<tr >
					<td colspan="3" style="text-align: center;font-weight: bold;">Groom Details</td>
				</tr>
				<?php
				foreach ($booked_groom_details as $row) {
