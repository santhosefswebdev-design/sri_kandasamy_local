        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <form action="<?php echo base_url(); ?>/prasadamsetting/save_prasadam_group" method="POST" enctype="multipart/form-data">
                        <div class="body">
                            ...
                            <div class="container-fluid">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="name_tamil" value="<?php echo $data['name_tamil']; ?>" <?php echo $readonly; ?>>
