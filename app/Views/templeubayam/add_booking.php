...
<style>
    ...
    .timing { display: flex; flex-direction: row; flex-wrap: wrap; gap: 10px 5px; }
	.timing div { border:1px solid #DDD; padding:5px 10px; }
</style>
                                ...
                                <div class="col-md-8 det">
                                        ...
                                        <div class="col-sm-3 ">
                                            <div class="form-group form-float">
                                                <div class="form-line" style="border: none;">
                                                    <label id="pack_add" class="btn btn-success" style="padding: 5px 12px !important;">Load Package</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="scroll products row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <select class="form-control" name="deity_id" id="deity_select">
                                                            <option value="">Select From</option>
...
function togglePayDetails() {
    ...
    function loadDeities(packageId) {
        var slotId = $('input[name="booking_slot[]"]:checked').val();
        let packageType = 2;
