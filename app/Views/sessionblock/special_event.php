...
<section class="content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/sessionblock/add_special_event"><button type="button" class="btn bg-deep-purple waves-effect"><?php echo $lang->add; ?></button></a></div>
    ...
    function confirm_modal(id) {
        ...
        $('#delete-form').attr('action', '<?php echo base_url(); ?>/sessionblock/delete_special_event/' + id);
    }
</script>
