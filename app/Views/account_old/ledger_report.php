    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <div class="row"><div class="col-md-4"><h2><?php echo $lang->general; ?> <?php echo $lang->ledger; ?></h2></div>
                        <div class="col-md-8">
							<?php
                        ...
                        <form action="<?php echo base_url(); ?>/accountreport/ledger_report" method="post">
                            <div class="container-fluid">
                                ...
                                <div class="col-sm-2" align="right">
                                    ...
                                    <label id="print" class="btn btn-primary btn-lg waves-effect"><?php echo $lang->print; ?></label>
                                </div>
                                <?php } ?>
                                </div>
                                </div>
                    ...
                    <form style="display: none;" target="_blank" action="<?php echo base_url(); ?>/accountreport/print_ledger_statement" method="POST" id="print_ledger">
                        ...
                        <button type="submit" id="print_sub" class="btn btn-success"><?php echo $lang->submit; ?></button>
                    </form>
	
	<div class="table-responsive">
    <table class="table table-striped" width="1000" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif; font-size: 15px;">
		<thead>
			<tr style="padding: 15px 0;">
				
				<td width="10%" align="left" style="border-bottom:1px solid black;padding: 15px 5px;"><strong><?php echo $lang->date; ?></strong></td>
				<td width="10%" align="left" style="border-bottom:1px solid black;"><strong><?php echo $lang->ref_no; ?></strong></td>
				<td width="25%" align="left" style="border-bottom:1px solid black;padding: 15px 5px;"><strong><?php echo $lang->ledger; ?></strong></td>
				<td width="16%" align="right" style="border-bottom:1px solid black;padding: 15px 5px;"><strong><?php echo $lang->debit; ?> <?php echo $lang->amount; ?></strong></td>
				<td width="16%" align="right" style="border-bottom:1px solid black;padding: 15px 5px;"><strong><?php echo $lang->credit; ?> <?php echo $lang->amount; ?></strong></td>
				<td width="18%" align="right" style="border-bottom:1px solid black;padding: 15px 5px;"><strong><?php echo $lang->balance; ?> <?php echo $lang->amount; ?></strong></td>
			</tr>
		</thead>
		<tbody>
			<tr style="background-color: #a1a09f;">
				<td></td><td colspan="2"><?php echo $lang->opening; ?> <?php echo $lang->balance; ?></td><td></td><td></td><td align="right" style="padding: 15px 5px;"><?= str_replace('-0.00', '0.00', number_format($res['op_bal'], '2','.',',')); ?></td>
			</tr> 
			<?php 
			$cu_credit = 0;
			$cu_debit = 0;
			...
			<?php } ?>
			<tr style="background-color: #a1a09f;">
				<td></td><td colspan="2"><?php echo $lang->closing; ?> <?php echo $lang->balance; ?></td><td align="right"><?= number_format($cu_debit,'2','.',','); ?></td><td align="right"><?= number_format($cu_credit,'2','.',','); ?></td>
