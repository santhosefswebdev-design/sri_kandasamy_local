            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <div class="row">
                            <div class="col-md-6">
                                <h2>Stock Out Details - <?php echo $data['doc_no']; ?></h2>
                            </div>
                            <div class="col-md-6" align="right">
                                <?php if ($data['status'] == 'draft') { ?>
                                    <a href="<?php echo base_url(); ?>/invstockout/approve/<?php echo $data['id']; ?>">
                                ...
                                <a href="<?php echo base_url(); ?>/invstockout/print_page/<?php echo $data['id']; ?>"
                                    target="_blank">
                            ...
                            <div class="col-md-6">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Out Type:</th>
                                        <td><span
                                                class="label bg-purple"><?php echo strtoupper($data['out_type']); ?></span>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="col-md-6">
                                <table class="table">
                                    <tr>
                                        ...
                                        <td><?php echo !empty($data['department']) ? strtoupper($data['department']) : '-'; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Reference No:</th>
                                    ...
                                    <tr>
                                        <th>Issued To:</th>
                                        <td><?php echo !empty($data['issued_to']) ? $data['issued_to'] : '-'; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Status:</th>
                                        <td>
