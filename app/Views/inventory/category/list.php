                    ...
                    <div class="header">
                        <div class="row">
                            ...
                            <div class="col-md-4" align="right">
                                <a href="<?php echo base_url(); ?>/invcategory/add">
                                    <button type="button" class="btn bg-deep-purple waves-effect">Add Category</button>
                                </a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    if (!empty($list)) {
                                        foreach ($list as $row) { ?>
                                            <tr>
                                                ...
                                                <td><span class="label bg-blue"><?php echo strtoupper($row['type']); ?></span>
                                                </td>
                                                ...
                                                <td>
                                                    <a class="btn btn-success btn-rad" title="View"
                                                        href="<?= base_url() ?>/invcategory/view/<?php echo $row['id']; ?>"><i
                                                            class="material-icons">&#xE417;</i></a>
                                                    <a class="btn btn-primary btn-rad" title="Edit"
                                                        href="<?= base_url() ?>/invcategory/edit/<?php echo $row['id']; ?>"><i
                                                            class="material-icons">&#xE3C9;</i></a>
...
<script>
    ...
    function dedDel(id) {
        var act = "<?php echo base_url(); ?>/invcategory/delete/" + id;
