                    ...
                    <div class="header">
                        <div class="row">
                            ...
                            <div class="col-md-4" align="right">
                                <a href="<?php echo base_url(); ?>/invstockadjustment/add">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="label bg-blue">
                                                    <?php echo strtoupper(str_replace('_', ' ', $row['adjustment_type'])); ?>
                                                </span>
                                            </td>
                                            <td><?php echo !empty($row['reference_no']) ? $row['reference_no'] : '-'; ?>
                                            </td>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-rad" title="View"
                                                    href="<?= base_url() ?>/invstockadjustment/view/<?php echo $row['id']; ?>"><i
            ...
            <div class="modal-content">
                <div class="modal-body p-4">
                    <div class="text-center">
                        ...
                        <h4 class="mt-2">Delete Stock Adjustment</h4>
...
<script>
    ...
    function dedDel(id) {
        var act = "<?php echo base_url(); ?>/invstockadjustment/delete/" + id;
