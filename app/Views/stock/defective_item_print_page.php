            ...
            <table style="width:100%;" border="1">
                ...
                <tr>
                    <td width="40%" rowspan="3"> Staff name:
                        ...
                        <?php
                        // Check if address components are present in the data array
                    ...
                    <td width="30%">DEFECTIVE ITEM</td>
                </tr>


<tr>
    <td>Date : <?php echo date('d-m-Y'); ?>
    </td>
</tr>
    ...
    <tr>
        <td colspan="2">
            ...
            <p class="dot_line" style="bottom:0;position:relative;margin-top: 100px; text-align: center;">
