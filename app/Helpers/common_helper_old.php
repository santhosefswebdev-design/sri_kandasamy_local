...
if (!function_exists('loop_general_ledger_statement')) {
	...
	// 			log_message('info', 'WhatsApp URL: https://api.ultramsg.com/instance100384/messages/' . $url);

	// 			$curl = curl_init();
	// 			curl_setopt_array($curl, [
	// 				CURLOPT_URL => "https://api.ultramsg.com/instance100384/messages/" . $url,
	...
	// ================================
	// REPLACE THIS FUNCTION IN: app/Helpers/common_helper.php
	// ================================
